...
namespace Nop.Plugin.Widgets.CSlider.Data
{
    ...
    /// Object context
    /// </summary>
    public class CSliderObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public CSliderObjectContext(string nameOrConnectionString)
        ...
        {
            modelBuilder.Configurations.Add(new CSliderSlideMap());
        ...
        {
            //drop the table
            var tableName = this.GetTableName<CSliderSlide>();
